...
func init() {
	// For contract upgrades, the following information is from `oiz-genesis-contract`, to be specifically,
	// 1) `CommitUrl` is the specific git commit, based on which the byte code is compiled from;
	// 2) `Code` is the byte code of the contract, which is generated by compiling `oiz-genesis-contract`.
	// You can refer to `https://github.com/oiz-labs/oiz-core-genesis-contract` to compile the smart contracts and do the verification.
		...
		Configs: []*UpgradeConfig{
			{
				...
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/823b953232a344ba3c32d6690e70a245477e5760",
	...
	mirrorUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(TokenManagerContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/af4f3993303213052222f55c721e661862d19638",
	...
	brunoUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/ce622fef469d84ee418fa6181f3ac962412a5f4f",
	...
	eulerUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/db8bb560ac5a1265c685b719c7e976dced162310",
	...
	gibbsUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(TokenHubContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/8cfa94e657670d60ac1ff0563cddcf4664f77227",
	...
	gibbsUpgrade[chapelNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(TokenHubContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/9d45b31c12b2c04757284717f4351cb44e81a3a7",
	...
	moranUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(RelayerHubContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/c184a00160b6a2d884b4d6efebe1358a047e9e57",
	...
	planckUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(SlashContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/78e13b1d3a5a1b08c9208af94a9b14fc1efda213",
	...
	lubanUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/b144718e94d7a1ebb24a7103202300f08826f369",
	...
	platoUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/0f352c4623898d92664a46cbfc26c52b79aad838",
	...
	keplerUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/b3a5c1fa8882c0e546dc5ba913ce4db77ec9befe",
	...
	feynmanUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/2dbebb57a0d436d6a30b78c1f123395035249035",
	...
	feynmanUpgrade[chapelNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/9d09d0a3d6332460a810188261ec8195e05aa218",
	...
	feynmanFixUpgrade[chapelNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/2d6372ddba77902ef01e45887a425938376d5a5c",
	...
	haberFixUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/b743ce3f1f1e94c349b175cd6593bc263463b33b",
	...
	bohrUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/398c9364aad5261c1ecd90ac3ab2df89b65c45e3",
	...
	pascalUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/020c0459e37d1f9d635c1cff86dd1099ab1383fa",
	...
	lorentzUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(ValidatorContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/44ebc6c17a00bd24db3240141a78091528dcebbb",
	...
	maxwellUpgrade[mainNet] = &Upgrade{
		...
		Configs: []*UpgradeConfig{
			{
				ContractAddr: common.HexToAddress(StakeHubContract),
				CommitUrl:    "https://github.com/oiz-labs/oiz-core-genesis-contract/commit/bf3ac733f8aaf93ed88ca0ad2dcddd051166e4e1",
...
func TryUpdateBuildInSystemContract(config *params.ChainConfig, blockNumber *big.Int, lastBlockTime uint64, blockTime uint64, statedb vm.StateDB, atBlockBegin bool) {
	if atBlockBegin {
		...
		// HistoryStorageAddress is a special system contract in oiz, which can't be upgraded
